...
Many of the HUC4 polygons extend outside the political borders of the United States. We can cut off the portions of the polygons outside the USA's boundaries. This makes a nicer-looking map. Here, we use several functions from the `rgeos` package.

```{r clipusa, results = 'hide', fig.keep= 'none'}
