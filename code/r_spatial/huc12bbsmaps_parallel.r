...
load('/mnt/research/aquaxterra/DATA/huc12_fortified_withbbs_multiple.r')
...
ggsave(filename = paste0('/mnt/research/aquaxterra/FIGS/bbs_huc_maps_29nov/huc12_byroute_allbirds_', vars_to_plot[i], '_map.png'), plot = map_i, height = 6, width = 9, dpi = 400)
