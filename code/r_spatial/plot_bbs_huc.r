...
# save(huc12fort, file = '/mnt/research/aquaxterra/CODE/R/huc12fort.r')

# load('/mnt/research/aquaxterra/CODE/R/huc12fort.r')
...
# Plot without ggplot because it is too memory-hungry for such a big plot.

png('/mnt/research/aquaxterra/FIGS/huc_by_nbbs.png', height=9, width=12, res=300, units='in')
spplot(obj = huc12nolakes, zcol = 'nbbs', col = NA)
dev.off()
