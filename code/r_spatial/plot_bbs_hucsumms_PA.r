...
d_vars <- c(2, 4, 5, 7, 8)
clim_vars_temp <- 15:17
clim_vars_prec <- 18:20
topo_vars <- 9:10
nlcd_vars <- c(21:25, 30)
prod_vars <- 11:14

# Variable name labels.
dlabels <- c('TD: species richness', 'PD: pairwise', 'PD: nearest-taxon', 'FD: evenness', 'FD: dispersion')
...
dn <- '/mnt/research/aquaxterra/FIGS/bbs_huc_pairplots_new'
