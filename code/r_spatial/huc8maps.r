...
for (i in vars_to_plot) {
  ...
  ggsave(filename = paste0('/mnt/research/aquaxterra/FIGS/huc8maps/huc8_20012011_byroute_', i, '_map.png'), plot = map_i, height = 6, width = 9, dpi = 400)
  print(i)
}
