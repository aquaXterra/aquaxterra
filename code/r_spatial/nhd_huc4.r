...
save(lake_summary, river_summary, file = '/mnt/research/aquaxterra/DATA/albers_projected_data/NHD/HUC4_summaries.r')
...
write.csv(lake_summary, '/mnt/research/aquaxterra/DATA/albers_projected_data/NHD/HUC4_lake_areas.csv', row.names = FALSE)
write.csv(river_summary, '/mnt/research/aquaxterra/DATA/albers_projected_data/NHD/HUC4_river_lengths.csv', row.names = FALSE)
